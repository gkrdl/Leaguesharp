...
namespace hAram
{
    internal class Program
    {
        ...
        private static string[] ADCarry = { "ashe", "caitlyn", "corki", "draven", "ezreal", "gankplank", "graves", "jinx", "kalista", "kogmaw", "lucian", "masteryi", "missfortune", "quinn", "sivir", "tristana", "tryndamere", "twitch", "urgot", "varus", "vayne" };
