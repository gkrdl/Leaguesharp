...
namespace hAram
{
    class Base
    {
        ...
        public string[] APCarry = { "ahri", "anivia", "annie", "azir", "brand", "cassiopeia", "fiddlesticks", "galio", "gragas", "heimerdinger", "janna", "karma", "karthus", "kassadin", "leblanc", "lissandra", "lulu", "lux", "malzahar", "morgana", "nami", "nunu", "orianna", "ryze", "sona", "soraka", "swain", "syndra", "taric", "twistedfate", "veigar", "velkoz", "viktor", "xerath", "ziggs", "zilean", "zyra" };
        ...
        {
            if (Player.Team == GameObjectTeam.Chaos)
                spell.Cast(new Vector3(Player.Position.X + spell.Range / 2, Player.Position.Y + spell.Range / 2, Player.Position.Z));
            else
                spell.Cast(new Vector3(Player.Position.X - spell.Range / 2, Player.Position.Y - spell.Range / 2, Player.Position.Z));
